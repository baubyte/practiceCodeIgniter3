                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <center data-parsed=""> <img height="200" width="200" src="<?= base_url('assets/img/logo.jpeg') ?>" align="center" class="float-center"> </center>
                                  <table class="spacer">
                                    <tbody>
                                      <tr>
                                        <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
                                  ...
                                  <h4>Hemos creado una cuenta en sl Sistema para ti.</h4>
                                  <p>Los datos con los que fue registrada tu cuenta son</p>
                                  <p>Email: <strong><?= $email ?></strong></p>
                                  <p>Rango: <strong><?= $range?></strong></p>
                                  <p>Contraseña: <strong><?= $password ?></strong></p>
                                  <a class="button small-expanded" href="<?= base_url('login')?> ">ir al login</a>
                                  <br>
                                  <p>Resguarda estos datos ya que no son Transferibles.</p>
                                  <center data-parsed="">

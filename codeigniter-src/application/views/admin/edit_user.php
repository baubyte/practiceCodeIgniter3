        ...
        <div class="card-body">
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="nombre_usuario" value="<?= set_value('nombre_usuario', isset($user['nombre_usuario']) ? $user['nombre_usuario'] : '') ?>" class="form-control" placeholder="" readonly>
                    <input type="hidden" value="<?=set_value('id',isset($user['id']) ? $user['id'] : '')?>" name="id">
                </div>
                <div class="form-group col-md-4">
                    <label>Email</label>
                    <input type="email" name="email" value="<?=set_value('email',isset($user['email']) ? $user['email'] : '')?>" class="form-control" placeholder="" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label>Estado</label>
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="apellido" value="<?=set_value('apellido',isset($user['apellido']) ? $user['apellido']  : '')?>" class="form-control" placeholder="">
